...
Preserve the document's headings, paragraphs, lists, tables, emphasis, links, and reading order. Do not add commentary, explanations, or Markdown code fences. If there is no text, return an empty string.
